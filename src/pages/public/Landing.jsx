          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: 32 }}>
            ...
            <div style={{ display: 'flex', gap: 48 }}>
              ...
              <div>
                ...
                <button onClick={function(){navigate('/terms')}} style={{ display: 'block', background: 'none', border: 'none', padding: '4px 0', fontSize: 13, color: 'rgba(11,37,69,0.35)', cursor: 'pointer' }}>Terms</button><button onClick={function(){navigate('/contact')}} style={{ display: 'block', background: 'none', border: 'none', padding: '4px 0', fontSize: 13, color: 'rgba(11,37,69,0.35)', cursor: 'pointer' }}>Contact</button>
              </div>
            </div>
          </div>
