...
export default function CitizenLayout() {
  ...
  // Reels page: hide top header, dark transparent bottom tabs
    ...
    <div style={{ display: 'flex', minHeight: '100vh', fontFamily: sans, overflow: 'hidden', width: '100%', maxWidth: '100vw' }}>
      ...
      <div style={{ flex: 1, marginLeft: 0, minWidth: 0, display: 'flex', flexDirection: 'column', minHeight: '100vh', overflowX: 'hidden', maxWidth: '100%' }} className="cv-main">
        ...
        <nav className="cv-bottom-tabs" style={{
          ...
          background: isReelsPage ? 'rgba(11,37,69,0.92)' : 'linear-gradient(180deg, #0d2e55 0%, #0B2545 100%)',
          borderTop: 'none',
          paddingBottom: 'env(safe-area-inset-bottom, 8px)',
          backdropFilter: isReelsPage ? 'blur(16px)' : 'none',
              ...
              return (
                <NavLink key={tab.to} to={tab.to} end={tab.end || false}
                  ...
                  style={{
                    ...
                    color: tabActive ? C.gold : 'rgba(255,255,255,0.4)',
      ...
      <style>{'\
        ...
        *, *::before, *::after { box-sizing: border-box; }\
        ...
        @media (max-width: 768px) {\
          ...
          .cv-content-inner { padding: ' + (isReelsPage ? '0 !important; height: calc(100vh - 64px - env(safe-area-inset-bottom, 8px))' : '16px 14px 86px !important') + '; max-width: 100vw !important; overflow-x: hidden !important; word-break: break-word !important; }\
