      ...
      <div style={{ padding: "18px 20px 14px" }}>
        ...
        <div style={{ paddingTop: 10, borderTop: "1px solid " + T.border }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
            ...
            <button onClick={function() { var url = window.location.origin + '/citizen/community?post=' + post.id; if (navigator.share && /Mobi|Android/i.test(navigator.userAgent)) { navigator.share({ title: 'CivicVerify Post', url: url }); } else { navigator.clipboard.writeText(url); alert('Link copied!'); } }} style={{ display: "flex", alignItems: "center", gap: 5, padding: "6px 12px", borderRadius: 20, background: "rgba(197,150,12,0.08)", border: "1px solid rgba(197,150,12,0.25)", cursor: "pointer", fontFamily: T.sans, fontSize: 12, fontWeight: 700, color: "#C5960C", transition: "all 0.15s" }}>&#x1F517; Share</button>
